...
class UserManager(models.Manager):
    ...
    def login_validator(self, postData):
        ...
        elif not bcrypt.checkpw(postData["lpassword"].encode(),User.objects.get(email=postData["lemail"]).password.encode()):
            errors["lpassword"]= "Incorrect password."
        return errors
...
class Like(models.Model):
    ...
    message= models.ForeignKey(Message, related_name='likes') 
    created_at= models.DateTimeField(auto_now_add=True)
    updated_at= models.DateTimeField(auto_now=True)    
